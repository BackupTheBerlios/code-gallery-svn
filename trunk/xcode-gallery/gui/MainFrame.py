...
import wx
import AboutDialog
from gui.base import BMainFrame

def create(parent):
    return MainFrame(parent)

class MainFrame(BMainFrame.BMainFrame):
    def OnCmdAboutButton(self, event):
        # we show the about dialog
        abt = AboutDialog.AboutDialog(None)
        abt.Show()
        
    def OnCmdGenerateButton(self, event):
        wx.MessageBox('This action is not implemented yet')
